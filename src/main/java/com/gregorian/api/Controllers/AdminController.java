...
public class AdminController {
    ...
    public ResponseEntity<?> userDelete(
        ...
        try{
            ...
            return new ResponseEntity<>(new HttpResponseDTO("Sucesso", "Usuário excluído do sistema"), HttpStatus.OK);
            ...
            return new ResponseEntity<>(new HttpResponseDTO("Erro", e.getMessage()), HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public ResponseEntity<Object> userResetPassword(
        ...
        try {
            ...
            return new ResponseEntity<>(
                    new HttpResponseDTO("Sucesso ", "Senha resetada com sucesso"),
                    HttpStatus.OK);
...
//    }
    ...
    public ResponseEntity<Object> profissionalCreate(
        ...
        try{
            ...
            return new ResponseEntity<>(new HttpResponseDTO("Sucesso","Profissional cadastrado com sucesso"), HttpStatus.CREATED);
            ...
            return new ResponseEntity<>(new HttpResponseDTO("Erro","Erro no cadastro. Possivelmente este usuário já possui um Profissional vinculado"), HttpStatus.CONFLICT);
        }
    }
    ...
    @PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.DESC) Pageable pageable){
        ...
        List<ProfissionalListDTO> listDTO = profissionals.stream().map(item -> {
            return profissionalConverter.toListDTO(item);
        }).collect(Collectors.toList());
